                        ...
                        <div className="flex-1 flex flex-col">
                          ...
                          <div className="flex items-center justify-between mb-3 gap-2 flex-wrap">
                            <div className="text-gray-500 text-sm">
                              구매자:{' '}
                              <span
                                className="font-semibold cursor-pointer hover:text-[#7CBD00]"
                                onClick={() => openProfileModal(detail.buyerIdx)}
                              >
                                {detail.buyerMemIdMasked}
                              </span>
                            </div>
                            {detail.chatroomIdx && (
                              <button
                        ...
                        <div>
                          ...
                          <div className="font-semibold flex items-center gap-1">
                            ...
                            <span
                              ...
                              onClick={() => openProfileModal(selectedBid.bidderIdx)}
                            >
                              {selectedBid.bidderMemIdMasked || '-'}
                            </span>
                        ...
                        >
                          <div className="flex justify-between mb-1">
                            <div className="font-semibold text-sm flex items-center gap-1">
                              ...
                              <span
                                onClick={e => { e.stopPropagation(); openProfileModal(bid.bidderIdx); }}
                                className="cursor-pointer text-gray-900 hover:text-[#7CBD00]"
                              >
