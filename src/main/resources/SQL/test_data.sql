...
INSERT INTO payment (
    bid_idx, mem_idx, payment_key, order_id,
    pay_method, pay_amount, pay_status,
    buyer_name, buyer_tel, buyer_addr, buyer_zipcode,
    pay_regdate, confirmed_at, canceled_at,
    delivery_status, courier_company, tracking_number, shipped_at
) VALUES

-- 1) auction4 / bid9 (buyer=10, bidder=10, 셀프매칭, 리뷰 존재) -> 구매확정 완료
(9, 10, 'dummy_payment_key_01', 'ORDER_DUMMY_001',
 '카드', 220000, 'CONFIRMED',
 '회원10', '010-1010-1010', '대구광역시 남구 대명동 123-45', '42200',
 NOW() - INTERVAL 5 DAY,
 NOW() - INTERVAL 3 DAY, NULL,
 'DELIVERED', 'CJ대한통운', '111122223333',
 NOW() - INTERVAL 4 DAY),

-- 2) auction5 / bid12 (buyer=8, bidder=8, 셀프매칭, 리뷰 존재) -> 구매확정 완료
(12, 8, 'dummy_payment_key_02', 'ORDER_DUMMY_002',
 '카드', 150000, 'CONFIRMED',
 '회원08', '010-0808-0808', '서울특별시 강남구 역삼동 678-90', '06100',
 NOW() - INTERVAL 6 DAY,
 NOW() - INTERVAL 4 DAY, NULL,
 'DELIVERED', '한진택배', '444455556666',
 NOW() - INTERVAL 5 DAY),

-- 3) auction1 / bid1 (buyer=1, bidder=9) -> 결제완료, 배송준비중
--    => MyPayments(user1): 배송준비중 / MySales(user9): 운송장 입력 버튼
(1, 1, 'dummy_payment_key_03', 'ORDER_DUMMY_003',
 '카드', 130000, 'DONE',
 '회원01', '010-0101-0101', '경기도 수원시 팔달구 매산로 1', '16480',
 NOW() - INTERVAL 1 DAY,
 NULL, NULL,
 NULL, NULL, NULL, NULL),

-- 4) auction2 / bid4 (buyer=2, bidder=4) -> 결제완료, 배송중
--    => MyPayments(user2): 구매확정 버튼 노출 / MySales(user4): 배송중
(4, 2, 'dummy_payment_key_04', 'ORDER_DUMMY_004',
 '계좌이체', 750000, 'DONE',
 '회원02', '010-0202-0202', '인천광역시 남동구 구월동 55-1', '21500',
 NOW() - INTERVAL 2 DAY,
 NULL, NULL,
 'SHIPPING', '롯데택배', '777788889999',
 NOW() - INTERVAL 1 DAY),

-- 5) auction3 / bid7 (buyer=9, bidder=1) -> 결제완료, 배송준비중
--    => MyPayments(user9): 배송준비중 / MySales(user1): 운송장 입력 버튼
(7, 9, 'dummy_payment_key_05', 'ORDER_DUMMY_005',
 '카드', 150000, 'DONE',
 '회원09', '010-0909-0909', '부산광역시 해운대구 우동 1234', '48058',
 NOW() - INTERVAL 12 HOUR,
 NULL, NULL,
 NULL, NULL, NULL, NULL),

-- 6) auction6 / bid15 (buyer=3, bidder=4) -> 구매확정 완료
--    => MyPayments(user3) / MySales(user4) 둘 다 거래완료 표시
(15, 3, 'dummy_payment_key_06', 'ORDER_DUMMY_006',
 '카드', 160000, 'CONFIRMED',
 '회원03', '010-0303-0303', '대전광역시 유성구 봉명동 99-9', '34188',
 NOW() - INTERVAL 4 DAY,
 NOW() - INTERVAL 2 DAY, NULL,
