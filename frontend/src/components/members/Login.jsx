                    ...
                    <div className="px-6 py-6">
                        <form className="space-y-6" onSubmit={handleLoginSubmit}>
                            ...
                            <div className="min-h-[20px]">
                                {errorMsg && (
                                    <div className={`text-xs font-bold ${errorMsg.includes("제한") ? "text-red-600" : "text-red-500"}`}>
                                        {errorMsg}
                                    </div>
                                )}
                                ...
                                {remainingSeconds === 0 && errorMsg.includes("제한") && (
                                    <div className="text-xs text-[#7CBD00] font-bold mt-2 text-center animate-bounce">
