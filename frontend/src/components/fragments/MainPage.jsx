              ...
              <div className="absolute inset-0 flex items-center">
                <div className="max-w-[1200px] mx-auto w-full px-10 box-border">
                  <div className="color-white text-left">
                    ...
                    <button className="bg-white text-[#222] border-none px-10 py-[15px] rounded-lg font-bold cursor-pointer">
                      지금 시작하기
                    </button>
                  </div>
                </div>
  ...
  return (
    <section className="max-w-[1200px] mx-auto px-10 py-[60px] border-t border-[#f5f5f5] box-border">
      <div className="flex justify-between items-end mb-8">
        ...
        <span className="text-[14px] font-medium cursor-pointer">더보기</span>
      </div>
