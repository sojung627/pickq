...
(6, 1,
 'https://images.unsplash.com/photo-1551958219-acbc608c6377?auto=format&fit=crop&w=800&q=80',
 '동호회 경기용 축구공 구합니다 ⚽ #26',
 '주말 동호회에서 사용할 공을 찾고 있습니다. 바람이 잘 빠지지 않고 상태 좋은 제품이면 좋겠습니다.',
 50000, 25,
 NOW() - INTERVAL 7 DAY,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 1 DAY,
...
(7, 2,
 ...
 '초보자용 배드민턴 라켓 구해요 🏸 #27',
 '손목 부담이 적은 가벼운 라켓을 찾고 있습니다. 줄 상태가 괜찮고 바로 사용할 수 있으면 좋겠습니다.',
 100000, 32,
 NOW() - INTERVAL 12 DAY,
 NOW() - INTERVAL 6 DAY,
 NOW() - INTERVAL 4 DAY,
 3,
 NOW() - INTERVAL 12 DAY, NOW() - INTERVAL 4 DAY,
 'N', NULL),
...
(8, 3,
 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=800&q=80',
 '자전거 헬멧 M사이즈 구합니다 🚴 #28',
 '통풍이 잘 되고 충격 흡수 상태가 좋은 헬멧을 찾습니다. 큰 흠집이나 균열이 없는 제품만 부탁드립니다.',
 180000, 39,
 NOW() - INTERVAL 15 DAY,
 NOW() - INTERVAL 10 DAY,
 NOW() - INTERVAL 8 DAY,
...
(9, 4,
 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&w=800&q=80',
 '쿠션 좋은 데일리 러닝화 구합니다 👟 #29',
 '주 3회 조깅에 사용할 편안한 러닝화를 찾습니다. 밑창 마모가 적고 쿠션이 살아 있으면 좋겠습니다.',
 130000, 46,
 NOW() - INTERVAL 9 DAY,
 NOW() - INTERVAL 5 DAY,
 NOW() - INTERVAL 3 DAY,
 5,
 NOW() - INTERVAL 9 DAY, NOW() - INTERVAL 3 DAY,
 'N', NULL),
...
(10, 5,
 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=800&q=80',
 '홈트용 덤벨 세트 구합니다 🏋️ #30',
 '집에서 사용할 조절식 덤벨 세트를 찾습니다. 손잡이와 고정 장치가 튼튼한 제품이면 좋겠습니다.',
 250000, 53,
 NOW() - INTERVAL 3 DAY,
 NOW() + INTERVAL 1 DAY,
 NOW() + INTERVAL 3 DAY,
...
(1, 6,
 ...
 '입문용 캠핑 텐트 구합니다 🏕️ #31',
 '2~3명이 사용할 수 있는 설치 쉬운 텐트를 찾습니다. 방수 상태와 구성품을 알려주세요.',
 350000, 60,
 NOW() - INTERVAL 4 DAY,
 NOW() + INTERVAL 2 DAY,
 NOW() + INTERVAL 4 DAY,
...
(2, 7,
 'https://images.unsplash.com/photo-1530549387789-4c1017266635?auto=format&fit=crop&w=800&q=80',
 '성인 수영 입문 세트 구해요 🏊 #32',
 '수경과 수모를 포함한 입문용 세트를 찾습니다. 위생 상태가 좋고 바로 사용할 수 있으면 좋겠습니다.',
 120000, 67,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 3 DAY,
 NOW() + INTERVAL 5 DAY,
...
(3, 8,
 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&w=800&q=80',
 '대용량 스포츠 백팩 구합니다 🎒 #33',
 '운동복과 신발을 함께 넣을 수 있는 큰 가방을 찾습니다. 지퍼와 어깨끈 상태가 좋으면 좋겠습니다.',
 110000, 74,
 NOW() - INTERVAL 2 DAY,
 NOW() + INTERVAL 4 DAY,
 NOW() + INTERVAL 6 DAY,
...
(4, 1,
 ...
 '인조잔디용 풋살공 좋은 제품 찾아요 #34',
 '인조잔디 구장에서 사용할 예정입니다. 표면 손상이 적고 그립감 좋은 제품으로 제안 부탁드립니다.',
 80000, 81,
 NOW() - INTERVAL 3 DAY,
 NOW() + INTERVAL 5 DAY,
 NOW() + INTERVAL 7 DAY,
...
(5, 2,
 'https://images.unsplash.com/photo-1535131749006-b7f58c99034b?auto=format&fit=crop&w=800&q=80',
 '중급자용 골프 아이언 세트 찾습니다 ⛳ #35',
 '중급자가 사용하기 좋은 아이언 세트를 찾습니다. 헤드와 샤프트 상태를 자세히 알려주세요.',
 700000, 7,
 NOW() - INTERVAL 4 DAY,
 NOW() + INTERVAL 6 DAY,
 NOW() + INTERVAL 8 DAY,
...
(6, 3,
 ...
 '러닝용 무릎 보호대 한 세트 찾아요 #36',
 '장거리 러닝 때 사용할 무릎 보호대를 찾고 있습니다. 늘어남이 적고 세탁 상태가 깨끗하면 좋겠습니다.',
 60000, 14,
 NOW() - INTERVAL 7 DAY,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 1 DAY,
...
(7, 4,
 ...
 '10km 대회용 경량 러닝화 찾아요 #37',
 '10km 대회에 신을 가벼운 러닝화를 원합니다. 사이즈와 사용 거리를 함께 알려주세요.',
 180000, 21,
 NOW() - INTERVAL 12 DAY,
 NOW() - INTERVAL 6 DAY,
 NOW() - INTERVAL 4 DAY,
...
(8, 5,
 'https://images.unsplash.com/photo-1599901860904-17e6ed7083a0?auto=format&fit=crop&w=800&q=80',
 '두꺼운 요가매트 상태 좋은 제품 찾아요 🧘 #38',
 '무릎 부담을 줄일 수 있는 두꺼운 매트를 찾습니다. 찢김이나 눌림이 심하지 않은 제품을 원합니다.',
 80000, 28,
 NOW() - INTERVAL 15 DAY,
 NOW() - INTERVAL 10 DAY,
 NOW() - INTERVAL 8 DAY,
...
(9, 6,
 'https://images.unsplash.com/photo-1551524559-8af4e6624178?auto=format&fit=crop&w=800&q=80',
 '겨울 스키 장비 풀세트 찾습니다 🎿 #39',
 '초보자가 사용할 스키와 부츠 세트를 찾습니다. 연식이 오래돼도 안전에 문제없는 제품이면 괜찮습니다.',
 500000, 35,
 NOW() - INTERVAL 9 DAY,
 NOW() - INTERVAL 5 DAY,
 NOW() - INTERVAL 3 DAY,
...
(10, 7,
 ...
 '미러 수경 기스 없는 제품 찾습니다 #40',
 '실내 수영장에서 사용할 미러 수경을 찾습니다. 렌즈 기스와 밴드 늘어남이 적은 제품을 원합니다.',
 70000, 42,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 5 DAY,
 NOW() + INTERVAL 7 DAY,
...
(1, 8,
 'https://images.unsplash.com/photo-1517649763962-0c623066013b?auto=format&fit=crop&w=800&q=80',
 '스마트워치 충전 케이블 급구해요 ⚡ #41',
 '운동 기록용 시계를 충전할 정품 호환 케이블을 찾습니다. 단선 없이 정상 작동하는 제품을 원합니다.',
 50000, 49,
 NOW() - INTERVAL 2 DAY,
 NOW() + INTERVAL 6 DAY,
 NOW() + INTERVAL 8 DAY,
...
(2, 1,
 ...
 '훈련용 공인구 여러 개 구매 원합니다 #42',
 '훈련용으로 여러 번 사용할 수 있는 내구성 좋은 공을 찾습니다. 사용감은 조금 있어도 괜찮습니다.',
 120000, 56,
 NOW() - INTERVAL 3 DAY,
 NOW() + INTERVAL 1 DAY,
 NOW() + INTERVAL 3 DAY,
...
-- 43. 라켓/골프
(3, 2,
 'https://images.unsplash.com/photo-1595435742656-5272d0b3fa82?auto=format&fit=crop&w=800&q=80',
 '테니스 입문용 라켓 제안 부탁드려요 🎾 #43',
 '테니스에 입문하려고 합니다. 그립 상태가 좋고 너무 무겁지 않은 제품을 원합니다.',
 150000, 63,
 NOW() - INTERVAL 4 DAY,
 NOW() + INTERVAL 2 DAY,
 NOW() + INTERVAL 4 DAY,
...
(4, 3,
 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?auto=format&fit=crop&w=800&q=80',
 '운동용 손목 보호대 상태 좋은 제품 구해요 #44',
 '헬스할 때 사용할 손목 보호대를 구합니다. 벨크로와 봉제 상태가 튼튼한 제품을 선호합니다.',
 50000, 70,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 3 DAY,
 NOW() + INTERVAL 5 DAY,
...
(5, 4,
 ...
 '발볼 넓은 러너용 운동화 제안해주세요 #45',
 '발볼이 넓어서 편한 모델을 찾고 있습니다. 앞코 눌림이 없고 상태 좋은 제품이면 좋겠습니다.',
 150000, 77,
 NOW() - INTERVAL 2 DAY,
 NOW() + INTERVAL 4 DAY,
 NOW() + INTERVAL 6 DAY,
...
(6, 5,
 ...
 '접이식 스쿼트 머신 구매 원합니다 #46',
 '보관이 쉬운 접이식 운동기구를 찾습니다. 프레임 흔들림이 없고 패드 상태가 깨끗하면 좋겠습니다.',
 200000, 84,
 NOW() - INTERVAL 7 DAY,
 NOW() - INTERVAL 1 DAY,
 NOW() + INTERVAL 1 DAY,
...
(7, 6,
 ...
 '감성 캠핑 랜턴 상태 좋은 제품 구해요 #47',
 '캠핑 테이블에 둘 랜턴을 찾습니다. 유리 파손이 없고 점화가 잘 되는 제품을 원합니다.',
 70000, 10,
 NOW() - INTERVAL 12 DAY,
 NOW() - INTERVAL 6 DAY,
 NOW() - INTERVAL 4 DAY,
...
(8, 7,
 ...
 '훈련용 숏핀 사이즈 맞는 제품 구합니다 #48',
 '자유형 훈련에 사용할 숏핀을 구합니다. 사이즈와 실제 착용 횟수를 함께 알려주세요.',
 90000, 17,
 NOW() - INTERVAL 15 DAY,
 NOW() - INTERVAL 10 DAY,
 NOW() - INTERVAL 8 DAY,
...
(9, 8,
 ...
 '야간 운동용 반사 액세서리 세트 찾아요 #49',
 '야간 러닝과 라이딩 때 사용할 반사 밴드나 장갑을 찾습니다. 눈에 잘 띄는 제품이면 좋겠습니다.',
 60000, 24,
 NOW() - INTERVAL 9 DAY,
 NOW() - INTERVAL 5 DAY,
 NOW() - INTERVAL 3 DAY,
...
INSERT INTO bid (
    ...
    bid_regdate, bid_moddate
      ...
      (26, 9, 1, 378000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (26, 10, 2, 385000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (27, 10, 3, 391000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 2,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY),
      (27, 1, 4, 398000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 4 DAY),
      (28, 1, 5, 404000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 3,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 8 DAY),
      (28, 2, 6, 411000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 8 DAY),
      (29, 2, 7, 417000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 4,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 3 DAY),
      (29, 3, 8, 424000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 4,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY),
      (30, 3, 9, 430000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (30, 4, 10, 437000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (31, 4, 11, 443000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (31, 5, 12, 450000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (32, 5, 13, 456000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (32, 6, 14, 463000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (33, 6, 15, 469000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (33, 7, 16, 476000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (34, 7, 17, 482000, 2, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (34, 8, 18, 489000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (35, 8, 19, 495000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (35, 9, 20, 502000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (36, 9, 21, 508000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (36, 10, 22, 515000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (37, 10, 23, 521000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 2,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 4 DAY),
      (37, 1, 24, 528000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 4 DAY),
      (38, 1, 1, 534000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 3,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 8 DAY),
      (38, 2, 2, 541000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 8 DAY),
      (39, 2, 3, 547000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 4,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 3 DAY),
      (39, 3, 4, 554000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 4,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 3 DAY),
      (40, 3, 5, 560000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (40, 4, 6, 567000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (41, 4, 7, 573000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (41, 5, 8, 580000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (42, 5, 9, 586000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (42, 6, 10, 593000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (43, 6, 11, 599000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (43, 7, 12, 606000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (44, 7, 13, 612000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (44, 8, 14, 619000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (45, 8, 15, 625000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (45, 9, 16, 632000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (46, 9, 17, 638000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (46, 10, 18, 645000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (47, 10, 19, 651000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 2,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 4 DAY),
      (47, 1, 20, 658000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 4 DAY),
      (48, 1, 21, 664000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 3,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 8 DAY),
      (48, 2, 22, 671000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 8 DAY),
      (49, 2, 23, 677000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 4,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 3 DAY),
      (49, 3, 24, 684000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 4,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 3 DAY),
      (50, 3, 1, 690000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (50, 4, 2, 697000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (51, 4, 3, 703000, 2, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (51, 5, 4, 710000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (52, 5, 5, 716000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (52, 6, 6, 723000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (53, 6, 7, 729000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (53, 7, 8, 736000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (54, 7, 9, 742000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (54, 8, 10, 749000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (55, 8, 11, 755000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (55, 9, 12, 762000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (56, 9, 13, 768000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (56, 10, 14, 775000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (57, 10, 15, 781000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 2,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY),
      (57, 1, 16, 788000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 4 DAY),
      (58, 1, 17, 794000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 3,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 8 DAY),
      (58, 2, 18, 41000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 8 DAY),
      (59, 2, 19, 47000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 4,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 3 DAY),
      (59, 3, 20, 54000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 4,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY),
      (60, 3, 21, 60000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (60, 4, 22, 67000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (61, 4, 23, 73000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (61, 5, 24, 80000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (62, 5, 1, 86000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (62, 6, 2, 93000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (63, 6, 3, 99000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (63, 7, 4, 106000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (64, 7, 5, 112000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (64, 8, 6, 119000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (65, 8, 7, 125000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (65, 9, 8, 132000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (66, 9, 9, 138000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (66, 10, 10, 145000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (67, 10, 11, 151000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 2,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 4 DAY),
      (67, 1, 12, 158000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 4 DAY),
      (68, 1, 13, 164000, 2, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 3,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 8 DAY),
      (68, 2, 14, 171000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 8 DAY),
      (69, 2, 15, 177000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 4,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 3 DAY),
      (69, 3, 16, 184000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 4,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 3 DAY),
      (70, 3, 17, 190000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (70, 4, 18, 197000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (71, 4, 19, 203000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (71, 5, 20, 210000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (72, 5, 21, 216000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (72, 6, 22, 223000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (73, 6, 23, 229000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (73, 7, 24, 236000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (74, 7, 1, 242000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (74, 8, 2, 249000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (75, 8, 3, 255000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (75, 9, 4, 262000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (76, 9, 5, 268000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (76, 10, 6, 275000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (77, 10, 7, 281000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 2,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 4 DAY),
      (77, 1, 8, 288000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 4 DAY),
      (78, 1, 9, 294000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 3,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 8 DAY),
      (78, 2, 10, 301000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 8 DAY),
      (79, 2, 11, 307000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 4,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 3 DAY),
      (79, 3, 12, 314000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 4,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 3 DAY),
      (80, 3, 13, 320000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (80, 4, 14, 327000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (81, 4, 15, 333000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (81, 5, 16, 340000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (82, 5, 17, 346000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (82, 6, 18, 353000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (83, 6, 19, 359000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (83, 7, 20, 366000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (84, 7, 21, 372000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (84, 8, 22, 379000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (85, 8, 23, 385000, 2, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (85, 9, 24, 392000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (86, 9, 1, 398000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (86, 10, 2, 405000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (87, 10, 3, 411000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 2,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 4 DAY),
      (87, 1, 4, 418000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 4 DAY),
      (88, 1, 5, 424000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 3,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 8 DAY),
      (88, 2, 6, 431000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 8 DAY),
      (89, 2, 7, 437000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 4,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 3 DAY),
      (89, 3, 8, 444000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 4,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY),
      (90, 3, 9, 450000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (90, 4, 10, 457000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (91, 4, 11, 463000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (91, 5, 12, 470000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (92, 5, 13, 476000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (92, 6, 14, 483000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (93, 6, 15, 489000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (93, 7, 16, 496000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (94, 7, 17, 502000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (94, 8, 18, 509000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (95, 8, 19, 515000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (95, 9, 20, 522000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (96, 9, 21, 528000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (96, 10, 22, 535000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (97, 10, 23, 541000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 2,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 4 DAY),
      (97, 1, 24, 548000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 4 DAY),
      (98, 1, 1, 554000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 3,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 8 DAY),
      (98, 2, 2, 561000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 8 DAY),
      (99, 2, 3, 567000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 4,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 3 DAY),
      (99, 3, 4, 574000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 4,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 3 DAY),
      (100, 3, 5, 580000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (100, 4, 6, 587000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (26, 1, 7, 392000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (27, 2, 8, 405000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 3,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 4 DAY),
      (28, 3, 9, 418000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 3,
       NOW() - INTERVAL 4 DAY, NOW() - INTERVAL 8 DAY),
      (29, 4, 10, 431000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 4,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 3 DAY),
      (30, 5, 11, 444000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (31, 6, 12, 457000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (32, 7, 13, 470000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (33, 8, 14, 483000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (34, 9, 15, 496000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (35, 10, 16, 509000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (36, 1, 17, 522000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (37, 2, 18, 535000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 3,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 4 DAY),
      (38, 3, 19, 548000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 3,
       NOW() - INTERVAL 2 DAY, NOW() - INTERVAL 8 DAY),
      (39, 4, 20, 561000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 4,
       NOW() - INTERVAL 3 DAY, NOW() - INTERVAL 3 DAY),
      (40, 5, 21, 574000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (41, 6, 22, 587000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL),
      (42, 7, 23, 600000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 6 DAY, NULL),
      (43, 8, 24, 613000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 1 DAY, NULL),
      (44, 9, 1, 626000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (45, 10, 2, 639000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (46, 1, 3, 652000, 1, '구성품 모두 포함되어 있고 깨끗하게 보관했습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (47, 2, 4, 665000, 1, '실사용 횟수가 적어 상태가 매우 좋습니다.', 3,
       NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 4 DAY),
      (48, 3, 5, 678000, 1, '택배 포장 꼼꼼하게 해서 보내드리겠습니다.', 3,
       NOW() - INTERVAL 6 DAY, NOW() - INTERVAL 8 DAY),
      (49, 4, 6, 691000, 1, '가격 조정 없이 현재 제안가로 거래 가능합니다.', 4,
       NOW() - INTERVAL 1 DAY, NOW() - INTERVAL 3 DAY),
      (50, 5, 7, 704000, 1, '정상 작동 확인했고 사진과 동일한 상태입니다.', 1,
       NOW() - INTERVAL 2 DAY, NULL),
      (51, 6, 8, 717000, 1, '입문용으로 사용하기 좋은 제품이라 추천드립니다.', 1,
       NOW() - INTERVAL 3 DAY, NULL),
      (52, 7, 9, 730000, 1, '상품 상태가 좋아 바로 사용하실 수 있습니다.', 1,
       NOW() - INTERVAL 4 DAY, NULL),
      (53, 8, 10, 743000, 1, '사용감은 조금 있지만 기능에는 문제가 없습니다.', 1,
       NOW() - INTERVAL 5 DAY, NULL);
